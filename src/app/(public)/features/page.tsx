...
const featureSections = [
  {
    ...
    description: "Build and manage referral campaigns with powerful tools",
    items: [
      {
      ...
      {
        title: "Goal Types",
        desc: "Set goals based on visits, signups, or purchases. Track progress in real-time with live dashboards.",
        icon: (
          <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      },
      {
        ...
        desc: "Start from pre-built templates for social rewards, invites, gamification, or contests. Or build from scratch.",
        icon: (
          <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      },
      {
        ...
        desc: "Run contests, polls, and voting campaigns to engage participants and drive competition among referrers.",
        icon: (
          <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: "Drop widgets on any website with a single line of code",
    items: [
      {
        title: "Script Tag Embed",
        desc: "Add a single line of code to any website. Works on WordPress, Shopify, HTML, PHP, and more.",
        icon: (
          <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      },
      {
        ...
        desc: "Inline, popup, floating bar, or full page. Choose the mode that fits your site and audience.",
        icon: (
          <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      },
      {
        ...
        desc: "Match your brand colors, fonts, and messaging. Preview changes live before publishing.",
        icon: (
          <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      },
      {
        ...
        desc: "Widgets look great on desktop, tablet, and mobile devices. Adaptive layouts out of the box.",
        icon: (
          <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: "Incentivize sharing with flexible reward options",
    items: [
      {
        title: "Coupon Rewards",
        desc: "Distribute coupon codes automatically when participants reach goals. Supports single-use and multi-use codes.",
        icon: (
          <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      {
        title: "Cash Rewards",
        desc: "Offer cash incentives for successful referrals. Flexible payout options via PayPal and bank transfer.",
        icon: (
          <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      {
        title: "Token Rewards",
        desc: "Distribute blockchain tokens to reward participants. Perfect for crypto and Web3 projects.",
        icon: (
          <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      },
      {
        ...
        desc: "Reward both the referrer and the person they referred. Double the incentive, double the growth.",
        icon: (
          <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: "Measure every click, share, and conversion in real-time",
    items: [
      {
        title: "Real-Time Dashboard",
        desc: "See clicks, shares, impressions, and conversions as they happen on an intuitive analytics dashboard.",
        icon: (
          <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      },
      {
        ...
        desc: "Every share gets a unique tracked URL. Know exactly where clicks come from and which channels perform best.",
        icon: (
          <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      {
        title: "Leaderboards",
        desc: "See your top referrers ranked by clicks, shares, and successful referrals. Fuel competition.",
        icon: (
          <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      {
        title: "CSV Export",
        desc: "Export participant data, campaign stats, and analytics anytime for offline analysis and reporting.",
        icon: (
          <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    items: [
      {
        title: "MailChimp",
        desc: "Sync participants to your email marketing lists automatically. Trigger campaigns on referral events.",
        icon: (
          <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      {
        title: "Shopify",
        desc: "Connect your Shopify store for product-based referral campaigns. Track purchases and conversions.",
        icon: (
          <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      {
        title: "Zapier",
        desc: "Connect to 5,000+ apps with Zapier triggers and actions. Automate your referral workflows.",
        icon: (
          <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      {
        title: "REST API",
        desc: "Full API access for custom integrations. Webhooks for real-time events and complete developer docs.",
        icon: (
          <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: "Make it fully yours with complete branding control",
    items: [
      {
        title: "Custom Subdomains",
        desc: "Use your own subdomain (refer.yourbrand.com) for referral pages with full SSL support.",
        icon: (
          <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      },
      {
        ...
        desc: "Point your own domain to Referrals.com for a fully branded experience your users will trust.",
        icon: (
          <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      },
      {
        ...
        desc: "Manage multiple brands from a single dashboard with independent campaigns and separate analytics.",
        icon: (
          <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      },
      {
        ...
        desc: "Customize every email your participants receive. Match your brand voice and visual identity.",
        icon: (
          <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
          </svg>
      ...
      <section className="bg-gradient-to-r from-[#ff646c] to-[#ff4f58] py-16">
        <div className="mx-auto max-w-4xl px-4 text-center">
          ...
          <div className="mt-8 flex items-center justify-center gap-4">
            ...
            <Link
              href="/pricing"
              className="rounded-xl border border-white/30 px-8 py-3.5 text-lg font-semibold text-white transition-all hover:bg-white/10"
            >
              View Pricing
            </Link>
          </div>
