...
function SidebarInset({ className, ...props }: React.ComponentProps<"div">) {
  return (
    // min-w-0 stops wide content from stretching this flex item past the
    // viewport; overflow-x-clip contains whatever still escapes without
    // creating a scroll container, so sticky descendants keep working.
    <div
